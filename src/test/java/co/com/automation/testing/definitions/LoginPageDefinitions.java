...
public class LoginPageDefinitions {
    ...
    public void inicioDeSesiónFallido(String expectedErrorMessage) {
    ...
    public void faltaNombreDeUsuario(String expectedErrorMessage) {
    ...
    public void usuarioIniciarSesiónConCredencialesY(String username, String password) {
    ...
    public void deberíaPoderVerMensajeDeErrorDebajoDeLaContrasena(String expectedErrorMessage) {
